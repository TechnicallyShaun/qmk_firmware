...
// Home Row Mods - GACS order (GUI, Alt, Ctrl, Shift)
#define HOME_A LGUI_T(KC_A)       // Tap: A, Hold: GUI (Win/Cmd)
#define HOME_S LALT_T(KC_S)       // Tap: S, Hold: Alt
#define HOME_D LCTL_T(KC_D)       // Tap: D, Hold: Ctrl
#define HOME_F LSFT_T(KC_F)       // Tap: F, Hold: Shift

#define HOME_J RSFT_T(KC_J)       // Tap: J, Hold: Shift
#define HOME_K RCTL_T(KC_K)       // Tap: K, Hold: Ctrl
#define HOME_L RALT_T(KC_L)       // Tap: L, Hold: Alt
#define HOME_SCLN RGUI_T(KC_SCLN) // Tap: ;, Hold: GUI (Win/Cmd)
...
[MAC_BASE] = LAYOUT_tkl_iso(
     ...
     KC_LCTL,  HOME_A,   HOME_S,   HOME_D,   HOME_F,   KC_G,     KC_H,     HOME_J,   HOME_K,   HOME_L,   HOME_SCLN,KC_QUOT,  KC_NUHS,  KC_ENT,
     KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,            KC_UP,
     KC_CAPS,  KC_LOPTN, KC_LCMMD,                               KC_SPC,                                 KC_RCMMD, KC_ROPTN, MO(MAC_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[WIN_BASE] = LAYOUT_tkl_iso(
     ...
     KC_LCTL,  HOME_A,   HOME_S,   HOME_D,   HOME_F,   KC_G,     KC_H,     HOME_J,   HOME_K,   HOME_L,   HOME_SCLN,KC_QUOT,  KC_NUHS,  KC_ENT,
     KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,             KC_UP,
     KC_CAPS,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_RGUI, MO(WIN_FN),KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
